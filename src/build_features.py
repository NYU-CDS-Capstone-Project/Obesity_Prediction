...
'''
####################################
Added New, Fu Shang, 11/13/2018
'''
def build_features_vitalAverage_24_27(patient_data, maternal_data, maternal_hist_data, lat_lon_data, env_data, reference_date_start, reference_date_end, feature_index, feature_headers):
    return build_features_vitalAverage(patient_data, maternal_data, maternal_hist_data, lat_lon_data, env_data, reference_date_start, reference_date_end, feature_index, feature_headers, 24, 27)

def build_features_vitalAverage_27_33(patient_data, maternal_data, maternal_hist_data, lat_lon_data, env_data, reference_date_start, reference_date_end, feature_index, feature_headers):
    return build_features_vitalAverage(patient_data, maternal_data, maternal_hist_data, lat_lon_data, env_data, reference_date_start, reference_date_end, feature_index, feature_headers, 27, 33)

def build_features_vitalAverage_33_42(patient_data, maternal_data, maternal_hist_data, lat_lon_data, env_data, reference_date_start, reference_date_end, feature_index, feature_headers):
    return build_features_vitalAverage(patient_data, maternal_data, maternal_hist_data, lat_lon_data, env_data, reference_date_start, reference_date_end, feature_index, feature_headers, 33, 42)

def build_features_vitalAverage_42_54(patient_data, maternal_data, maternal_hist_data, lat_lon_data, env_data, reference_date_start, reference_date_end, feature_index, feature_headers):
    return build_features_vitalAverage(patient_data, maternal_data, maternal_hist_data, lat_lon_data, env_data, reference_date_start, reference_date_end, feature_index, feature_headers, 42, 54)

def build_features_vitalAverage_54_66(patient_data, maternal_data, maternal_hist_data, lat_lon_data, env_data, reference_date_start, reference_date_end, feature_index, feature_headers):
    return build_features_vitalAverage(patient_data, maternal_data, maternal_hist_data, lat_lon_data, env_data, reference_date_start, reference_date_end, feature_index, feature_headers, 54, 66)

def build_features_vitalAverage_66_78(patient_data, maternal_data, maternal_hist_data, lat_lon_data, env_data, reference_date_start, reference_date_end, feature_index, feature_headers):
    return build_features_vitalAverage(patient_data, maternal_data, maternal_hist_data, lat_lon_data, env_data, reference_date_start, reference_date_end, feature_index, feature_headers, 66, 78)
...
def call_build_function(data_dic, data_dic_moms, data_dic_hist_moms, lat_lon_dic, env_dic, agex_low, agex_high, months_from, months_to, percentile, prediction='obese', mrnsForFilter=[]):
    ...
    print (feature_headers_vitalsLatest)
    print (type(build_features_vitalAverage_24_27))
    ...
    funcs = [
        ...
        (build_features_vitalAverage_24_27, [ feature_index_vitalLatest, [h+'-avg24to27' for h in feature_headers_vitalsLatest]]),
        (build_features_vitalAverage_27_33, [ feature_index_vitalLatest, [h+'-avg27to33' for h in feature_headers_vitalsLatest]]),
        (build_features_vitalAverage_33_42, [ feature_index_vitalLatest, [h+'-avg33to42' for h in feature_headers_vitalsLatest]]),
        (build_features_vitalAverage_42_54, [ feature_index_vitalLatest, [h+'-avg42to54' for h in feature_headers_vitalsLatest]]),
        (build_features_vitalAverage_54_66, [ feature_index_vitalLatest, [h+'-avg54to66' for h in feature_headers_vitalsLatest]]),
        (build_features_vitalAverage_66_78, [ feature_index_vitalLatest, [h+'-avg66to78' for h in feature_headers_vitalsLatest]]),
    ...
    zscore_headers = ['Vital: Wt for Length ZScore-AtBirth','Vital: Wt for Length ZScore-avg0to1','Vital: Wt for Length ZScore-avg1to3','Vital: Wt for Length ZScore-avg3to5','Vital: Wt for Length ZScore-avg5to7','Vital: Wt for Length ZScore-avg7to10','Vital: Wt for Length Zscore-avg10to13','Vital: Wt for Length ZScore-avg13to16','Vital: Wt for Length ZScore-avg16to19','Vital: Wt for Length ZScore-avg19to24','Vital: Wt for Length ZScore-avg24to27','Vital: Wt for Length ZScore-avg27to33','Vital: Wt for Length ZScore-avg33to42','Vital: Wt for Length ZScore-avg42to54','Vital: Wt for Length ZScore-avg54to66','Vital: Wt for Length ZScore-avg66to78','Vital: Wt for Length ZScore-latest']
    ...
    for ix, age in enumerate(['-AtBirth','-avg0to1','-avg1to3','-avg3to5','-avg5to7','-avg7to10','-avg10to13','-avg13to16','-avg16to19','-avg19to24','-avg24to27','-avg27to33','-avg33to42','-avg42to54','-avg54to66','-avg66to78','-latest']):
    ...
    headers += ['Vital: Wt for Length ZScore-gain0to78']
